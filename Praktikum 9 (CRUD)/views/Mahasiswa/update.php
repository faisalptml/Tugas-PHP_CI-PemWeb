  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        value="<?=$mhsedit->nim?>" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        value="<?=$mhsedit->nama?>" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        value="<?=$mhsedit->tmp_lahir?>" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        value="<?=$mhsedit->tgl_lahir?>" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="ipk" name="ipk" 
        value="<?=$mhsedit->ipk?>" type="text" class="form-control">
      </div>
    </div>
  </div> 
  <div class="form-group row">
