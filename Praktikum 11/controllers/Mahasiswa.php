...
class Mahasiswa extends CI_Controller {
    ...
    public function upload() {
            ...
            $array = explode('.',$_FILES['mhs_foto']['name']) ;
            $extension = end($array) ;

            $_newName = $_nim.'.'.$extension ;
            
            $config['file_name'] = $_newName ;

            $this->load->library('upload', $config);

            if ( ! $this->upload->do_upload("mhs_foto"))
            {
            ...
            else
            {
                ...
                $this->mahasiswa->update_foto($array_data) ;
