...
<html lang="en">
  <head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="<?php echo base_url ('img/2.png"') ?>" type="image/png">
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?php echo base_url ('css/bootstrap.min.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url ('css/animate.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url ('css/LineIcons.css') ?>">
  ...
  <body>
    ...
    <header id="home" class="hero-area">    
      ...
      <nav class="navbar navbar-expand-md bg-inverse fixed-top scrolling-navbar">
        <div class="container">
          <a href="index.html" class="navbar-brand"><img src="<?php echo base_url ('img/logo.png') ?>"></a>       
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto w-100 justify-content-end">
              ...
              <li class="nav-item">
                <a class="btn btn-singin" href="login" rel="nofollow"> Login</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="container">      
        <div class="row space-100">
          ...
          <div class="col-lg-6 col-md-12 col-xs-12 p-0">
            <div class="intro-img">
              <img src="<?php echo base_url ('img/3113.png')?>" >
            </div>            
          </div>
        </div> 
      </div>             
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-12 pl-0 pt-70 pr-5">
            <div class="business-item-img">
              <img src="<?php echo base_url ('img/business/business-img.png') ?>" class="img-fluid" alt="">
            </div>
          </div>
          <!-- End Col -->
          <!-- Start Col -->
      ...
      <div class="row gradient-bg">
        <div class="col-lg-12">
          <div class="team-text section-header text-center">
            <h1 class="section-title mb-5">Daftar Mahasiswa</h1>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <div class="team-thumb">
                <img src="<?php echo base_url ('img/team/322.jpg') ?>" class="img-fluid" alt="">
              </div>
              ...
              <div class="team-social-icons">
                ...
                <div class="team-inner text-center">
                  <h5 class="team-title">Paisal Patmal</h5>
                  <p>Lead Designer</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <div class="team-thumb">
                <img src="<?php echo base_url ('img/team/332.jpg') ?>" class="img-fluid" alt="">
              </div>
              ...
              <div class="team-social-icons">
                ...
                <div class="team-inner text-center">
                  <h5 class="team-title">Flora Syafiqa</h5>
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <div class="team-thumb">
                <img src="<?php echo base_url ('img/team/432.jpg') ?>" class="img-fluid" alt="">
              </div>
              ...
              <div class="team-social-icons">
                ...
                <div class="team-inner text-center">
                  <h5 class="team-title">Dimas Anggoro</h5>
                  <p>Content Writer</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <div class="team-thumb">
                <img src="<?php echo base_url ('img/team/433.jpg') ?>" class="img-fluid" alt="">
              </div>
              ...
              <div class="team-details">
                ...
                <div class="team-inner text-center">
                  <h5 class="team-title">Yoga Bagas</h5>
...
<a href="#" class="btn btn-border">Purchase</a>
          ...
          <!-- Start Col -->
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
              ...
              <div class="footer-logo">
               <img src="<?php echo base_url ('img/footer-logo.png') ?>" alt="">
              </div>
            </div>
             <!-- End Col -->
              <!-- Start Col -->
    ...
    <script src="<?php echo base_url ('js/nivo-lightbox.js') ?>"></script>     
